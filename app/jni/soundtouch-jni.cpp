...
#define JAVA_PACKAGE_NAME = "Java_com_soundtouch_android_helper_SoundTouchHelper";
//#define LOGV(...)
...
static void _processFile(SoundTouch *pSoundTouch, const char *inFileName, const char *outFileName)
{
    ...
    LOGV("sampleRate =%d,bits =%d ,channel=%d", sampleRate, bits, nChannels);
...
extern "C" DLL_PUBLIC jstring Java_com_soundtouch_android_helper_SoundTouchHelper_getVersionString(JNIEnv *env, jobject thiz)
{
    const char *verStr;
...
extern "C" DLL_PUBLIC jlong Java_com_soundtouch_android_helper_SoundTouchHelper_newInstance(JNIEnv *env, jobject thiz)
{
    return (jlong)(new SoundTouch());
}

extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_deleteInstance(JNIEnv *env, jobject thiz, jlong handle)
{
    SoundTouch *ptr = (SoundTouch *)handle;
    delete ptr;
}

extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_setTempo(JNIEnv *env, jobject thiz, jlong handle, jfloat tempo)
{
    SoundTouch *ptr = (SoundTouch *)handle;
    ptr->setTempo(tempo);
}

extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_setPitchSemiTones(JNIEnv *env, jobject thiz, jlong handle, jfloat pitch)
{
    SoundTouch *ptr = (SoundTouch *)handle;
    ptr->setPitchSemiTones(pitch);
}

extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_setSpeed(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
    SoundTouch *ptr = (SoundTouch *)handle;
    ptr->setRate(speed);
}

extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_setPitchOctaves(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
    SoundTouch *ptr = (SoundTouch *)handle;
    ptr->setPitchOctaves(speed);
}

extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_setPitch(JNIEnv *env, jobject thiz, jlong handle, jfloat speed)
{
    SoundTouch *ptr = (SoundTouch *)handle;
    ptr->setPitch(speed);
}

extern "C" DLL_PUBLIC jstring Java_com_soundtouch_android_helper_SoundTouchHelper_getErrorString(JNIEnv *env, jobject thiz)
{
...
extern "C" DLL_PUBLIC int Java_com_soundtouch_android_helper_SoundTouchHelper_processFile(JNIEnv *env, jobject thiz, jlong handle, jstring jinputFile, jstring joutputFile)
{
    SoundTouch *ptr = (SoundTouch *)handle;
...
// extern "C" DLL_PUBLIC void Java_com_soundtouch_android_helper_SoundTouchHelper_getSoundTouchParams(JNIEnv *env, jobject thiz,jlong handle)
// {
//     SoundTouch *ptr = (SoundTouch*)handle;
...
//     // ptr->getTDStretchParams(&sampleRate, &sequenceMs, &seekWindowMs, &overlapMs);

//     LOGV("JNI exception in SoundTouch::getSoundTouchParams: sampleRate=%d,sequenceMs=%d,seekWindowMs=%d,overlapMs=%d", sampleRate, sequenceMs, seekWindowMs, overlapMs);
