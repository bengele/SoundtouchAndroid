...
// void SoundTouch::getTDStretchParams(int *pSampleRate, int *pSequenceMs, int *pSeekWindowMs, int *pOverlapMs ){
//     if(pTDStretch != null){
//         pTDStretch->getParameters(pSampleRate,pSequenceMs,pSeekWindowMs,pOverlapMs);
//     }
// }
